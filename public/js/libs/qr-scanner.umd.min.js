...
(function (e, a) {
  "object" === typeof exports && "undefined" !== typeof module
    ...
    : "function" === typeof define && define.amd
      ? define(a)
      : ((e = "undefined" !== typeof globalThis ? globalThis : e || self), (e.QrScanner = a()));
})(this, function () {
  class e {
    ...
    static async createQrEngine(a) {
      ...
      let workerCode = document.querySelector("script[data-qr-worker]")?.textContent || "";
      if (!workerCode) {
        try {
          const r = await fetch("/js/libs/qr-scanner-worker.min.js?v=20260405-8");
          workerCode = await r.text();
          const wrappedWorkerMatch = workerCode.match(/new Blob\(\[\s*`([\s\S]*)`\s*\],\s*\{\s*type:\s*["']application\/javascript["']\s*\}\s*\)/);
          if (wrappedWorkerMatch) {
            workerCode = wrappedWorkerMatch[1];
          }
        } catch (e) {
          console.error("Failed to load worker:", e);
        }
      }
      a = () => new Worker(URL.createObjectURL(new Blob([workerCode], { type: "application/javascript" })));
      ...
      !this._active ||
        ...
        ("requestVideoFrameCallback" in this.$video ? this.$video.requestVideoFrameCallback.bind(this.$video) : requestAnimationFrame)(async () => {
          if (!(1 >= this.$video.readyState)) {
            ...
            try {
              var c = await e.scanImage(this.$video, { scanRegion: this._scanRegion, qrEngine: this._qrEnginePromise, canvas: this.$canvas, alsoTryWithoutScanRegion: !0 });
            } catch (d) {
    ...
    static _drawToCanvas(a, b, c, d = !1) {
      ...
      b = c.getContext("2d", { alpha: !1, willReadFrequently: !0 });
